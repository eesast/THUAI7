...
namespace absl
{
    ...
    namespace str_format_internal
    {
        ...
        auto FormatConvertImpl(const T& v, FormatConversionSpecImpl, FormatSinkImpl* sink)
            -> std::enable_if_t<!std::is_enum<T>::value && std::is_void<decltype(AbslStringify(std::declval<FormatSink&>(), v))>::value, ArgConvertResult<FormatConversionCharSetInternal::v>>
        {
            using FormatSinkT =
                absl::enable_if_t<sizeof(const T& (*)()) != 0, FormatSink>;
            auto fs = sink->Wrap<FormatSinkT>();
        ...
        template<typename T>
        typename std::enable_if<std::is_enum<T>::value && !HasUserDefinedConvert<T>::value && !strings_internal::HasAbslStringify<T>::value, IntegralConvertResult>::type
        ...
        private:
            ...
            template<typename T>
            struct DecayType<T, typename std::enable_if<!str_format_internal::HasUserDefinedConvert<T>::value && !strings_internal::HasAbslStringify<T>::value && std::is_enum<T>::value>::type>
            {
