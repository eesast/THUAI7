...
namespace absl
{
    ...
    namespace crc_internal
    {
        ...
        public:
            ...
            // is set.
            static void FillWordTable(uint32_t poly, uint32_t last, int word_size, Uint32By256* t);
        ...
        private:
            ...
            static void ExtendByZeroesImpl(uint32_t* crc, size_t length, const uint32_t zeroes_table[256], const uint32_t poly_table[256]);
