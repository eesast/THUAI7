...
namespace absl
{
    ...
    namespace synchronization_internal
    {
        ...
        public:
            ...
            static constexpr KernelTimeout Never()
            {
                return KernelTimeout();
            }
            ...
            bool is_absolute_timeout() const
            {
                return (rep_ & 1) == 0;
            }
            ...
            // because all indefinite timeouts are equivalent.
            bool is_relative_timeout() const
            {
                return (rep_ & 1) == 1;
            }
            ...
            static constexpr bool SupportsSteadyClock()
            {
                return true;
            }
        ...
        private:
            ...
            int64_t RawAbsNanos() const
            {
                return static_cast<int64_t>(rep_ >> 1);
            }
