...
namespace absl
{
    ...
    namespace base_internal
    {
        ...
        inline void* DirectMmap(void* start, size_t length, int prot, int flags, int fd, off_t offset) noexcept
        {
    ...
    (defined(__sparc__) && !defined(__arch64__))
            ...
            return __mmap2(start, length, prot, flags, fd, static_cast<size_t>(offset / pagesize));
#else
