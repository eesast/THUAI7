...
#if defined(__GNUC__) && defined(__STDC_VERSION__) && !defined(__MINGW32__) && !defined(__MINGW64__) && !defined(__APPLE__)
    /*
...
#undef ossl_bio__printf__
    ...
    int BIO_meth_set_gets(BIO_METHOD* biom, int (*ossl_gets)(BIO*, char*, int));
