...
namespace re2
{
    ...
    public:
        ...
        RE2::ErrorCode Add(absl::string_view pattern, const RE2::Options& options, int* id);
        ...
        // matched_regexps.
        bool AllMatches(absl::string_view text, const std::vector<int>& atoms, std::vector<int>* matching_regexps) const;
