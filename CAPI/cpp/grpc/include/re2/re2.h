...
namespace re2
{
    ...
    private:
        ...
        bool DoMatch(absl::string_view text, Anchor re_anchor, size_t* consumed, const Arg* const args[], int n) const;
    ...
    namespace re2_internal
    {
        ...
        template<>
        struct Parse3ary<absl::string_view> : public std::true_type
        {
        };
        template<>
        ...
        template<typename T>
        struct Parse3ary<absl::optional<T>> : public Parse3ary<T>
        {
        };
        template<typename T>
        struct Parse4ary<absl::optional<T>> : public Parse4ary<T>
        {
        };
